...
<body>
  ...
  <div class="position-absolute top-0 end-0">
    ...
    <h2 class="mb-3 text-center me-5">DAFTAR BARANG</h2>
    <?php
            if (isset($_GET['status'])) {
              if ($_GET['status'] == "stok_tidak_cukup") {
    ...
    <?php
      ...
      <div class="col-md-3 mt-3 mb-3">
        <div class="card" style="width:18rem">
          <div class="card-body">
            <img src=<?php echo "'fotobarang/".$form['foto']."'" ?> alt="" height="200px">
            <h5 class="card-title"></h5>
            <h5 class="card-text"><?php 
            
         
              if ($form['stok'] == 0) {
               // display "barang tidak tersedia" message
                echo "Maaf, barang tidak tersedia."; 
             }else{
              echo 'Tersedia '. $form['stok']; 
             }
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <form action="meminjam.php" method="POST" role="form" onsubmit="return showPopup()">
          <div class="modal-body">
            ...
            <input type="text" name="username" class="form-control" id="inputPassword3"
              value="<?php echo $form['username']; ?>" readonly>
            <label for="inputPassword3" class="col-form-label">Nama</label>
            <input type="text" name="nama" class="form-control" id="inputPassword3" value="<?php echo $form['nama']; ?>"
              readonly>
            <label for="inputPassword3" class="col-form-label">Kelas</label>
            <input type="text" name="kelas" class="form-control" id="inputPassword3"
              value="<?php echo $form['kelas']; ?>" readonly>

            <label for="inputPassword3" class="col-form-label">Jumlah</label>
            <input type="number" name="jumlah" class="form-control" id="inputPassword3" required>
            <label for="inputPassword3" class="col-form-label">Keterangan</label>
            <input type="text" name="keterangan" class="form-control" id="inputPassword3" required>

            <label for="inputState" class="form-label">Barang</label>
            <select name='kode_barang' id='kode_barang' class='form-control' min="1" required>
              <option value="Silahkan Pilih Barang">Silahkan Pilih Barang</option>
              <?php include 'config.php'; 
            ...
            <select id="inputState" name="hari" class="form-select" required>
            ...
            <label for="inputPassword3" class="col-form-label">Tgl Peminjaman</label>
            <input type="date" name="tanggal_peminjaman" class="form-control" id="inputPassword3" required>
        </form>
        <?php }
?>
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" name='pinjam' class="btn btn-danger" data-bs-dismiss="modal">pinjam</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    function showPopup() {
      // Display the pop-up
      alert("Apakah Data yang Di input sudah benar ?");
