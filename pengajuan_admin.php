...
<body>
  ...
  <nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left"
    ...
    <a href="pengajuan_admin.php" onclick="w3_close()" class="w3-bar-item w3-button"><i
        ...
        <a href="pengembalian_admin.php" onclick="w3_close()" class="w3-bar-item w3-button"><i class="fa-solid fa-arrow-right-arrow-left"></i> Daftar Pengembalian</a>
              ...
              if (isset($_GET['status'])) {
                if ($_GET['status'] == "sukses") {
                  echo '<div class="alert alert-primary alert-dismissible fade show row-4 text-center ms-3" role="alert" id="message">';
                    ...
                    echo '</svg>';
              echo 'Pengajuan Berhasil Di Verifikasi';
                  echo '</div>';
                  echo "<script>
                  setTimeout(function() {
